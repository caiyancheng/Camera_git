...
root_path = r'E:\sony_pictures\a7R3_100_aruco_4_demosaic_100_distance'
...
for json_file in tqdm(json_file_list):
    json_file_ID = json_file.split('\\')[-1].split('.')[0].split('_')[-1]
...
cv2.imwrite(os.path.join(root_path, f'aligned_combine_2.png'), aligned_image_average_array)
