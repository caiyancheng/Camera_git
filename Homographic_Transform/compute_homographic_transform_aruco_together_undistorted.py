...
for img_path in img_path_list:
    ...
    if ids is not None:
        ...
        with open(os.path.join(img_root_path, f'homography_aruco_result_{img_ID}_undistorted.json'), 'w') as fp:
            json.dump(json_data, fp)
    else:
        print("No markers detected.")

    # 显示结果
    output_path = f'Display_ArUco_together_{img_ID}_resize_{resize_scale}_blur_{blur_kernel_size}_undistorted.png'
