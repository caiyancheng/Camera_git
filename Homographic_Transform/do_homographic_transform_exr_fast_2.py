...
for img_name in image_list:
    ...
    aligned_white_mask = cv2.warpPerspective(white_mask, homography_matrix,
                                             (display_image_record_width, display_image_record_height))
    aligned_image = cv2.warpPerspective(image, homography_matrix,
                                        (display_image_record_width, display_image_record_height))
    ...
    cropped_image = aligned_image_average_array[start_y:start_y + central_crop_display_image_record_height,
    ...
    cv2.imwrite(os.path.join(root_path, f'aligned_combine_exr_{img_pure_name}_center_crop.png'), cropped_image)
